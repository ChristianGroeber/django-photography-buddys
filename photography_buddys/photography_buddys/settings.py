"""
Django settings for photography_buddys project.
...
SECRET_KEY = '_n=(3#l$9ey^!rb99t9d6yldqdef4sdwa+@d3b#-$k!5gj&f(x'
...
ROOT_URLCONF = 'photography_buddys.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'website.context_processors.loggedin_user',
            ],
        },
    },
]
